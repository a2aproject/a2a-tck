...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Gherkin scenarios exist for historyLength parameter behavior
- [ ] #2 Requirement definitions cover MUST and MAY aspects of task history
- [ ] #3 Compatibility tests validate historyLength=0 returns no history
- [ ] #4 Compatibility tests validate historyLength>0 returns history with correct messages
- [ ] #5 All three transports (JSONRPC, gRPC, HTTP+JSON) are tested
- [ ] #6 All SUTs regenerated and passing new tests
<!-- AC:END -->
